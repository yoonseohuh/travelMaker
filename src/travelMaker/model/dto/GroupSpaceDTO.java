...
public class GroupSpaceDTO {
	...
	public Integer getDongsung() { return dongsung; }
	public void setDongsung(Integer dongsung) { this.dongsung = dongsung; }
	
	public String getCourseExpl() { return courseExpl; }
	public void setCourseExpl(String courseExpl) { this.courseExpl = courseExpl; }
	
	public String getAddExpl() { return addExpl; }
	public void setAddExpl(String addExpl) { this.addExpl = addExpl; }
	...
	public Integer getReadCnt() { return readCnt; }
	public void setReadCnt(Integer readCnt) { this.readCnt = readCnt; }
	
	public Integer getShared() { return shared; }
	public void setShared(Integer shared) { this.shared = shared; }
	
	public String getGenReview() { return genReview; }
	public void setGenReview(String genReview) { this.genReview = genReview; }
