		...
		<div class="manualBody">
			<div class="manualInfo">
				...
				<div class="manualSubTit">
					<p>부가설명을 넣어줍니다. 제목보다 조금 긴 정도가 이쁘겠죠</p>
				</div>
			</div>
			<!--manualInfo end -->
			<div class="picWrap">
			...
			<div class="manualMix">
				<div class="txtArea">
					<div class="txtLoc">
						...
						<div class="txtCont">
							<p>Travel Maker는 당신의 여행을 모험으로, 때로는 게임으로 만들어드립니다. 
							 그리고 때론 여수밤바다로 만들어드리죠. 아 아 아 아 아 아 아너와 함께 걷고 싶다이 바다를
					...
					<div class="txtLoc">
						...
						<div class="txtCont">
							<p>여수 밤바다 이 조명에 담긴아름다운 얘기가 있어네게 들려주고파전활 걸어뭐 하고
							 있냐고나는 지금 여수 밤바다여수 밤바다아 아 아 아 아 아 아너와 함께 걷고 싶다이 바다를
							 너와 함께 걷고 싶어이 거리를너와 함께 걷고 싶다이 바다를너와 함께 걷고 싶어여수
							 밤바다여수 밤바다이 바람에 걸린알 수 없는 향기가 있어네게 전해 주고파전활 걸어
							 뭐 하고 있냐고나는 지금 여수 밤바다여수 밤바다아 아 아 아 아 아 </p>
